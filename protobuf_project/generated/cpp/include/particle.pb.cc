...
static void InitDefaultsscc_info_Person_particle_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::PhysicsTelemetry::_Person_default_instance_;
    new (ptr) ::PhysicsTelemetry::Person();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::PhysicsTelemetry::Person::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_particle_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Person_particle_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_particle_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::PhysicsTelemetry::Person, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::PhysicsTelemetry::Person, position_),
  PROTOBUF_FIELD_OFFSET(::PhysicsTelemetry::Person, velocity_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::PhysicsTelemetry::Person)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::PhysicsTelemetry::_Person_default_instance_),
};

const char descriptor_table_protodef_particle_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016particle.proto\022\020PhysicsTelemetry\032\020base"
  "_types.proto\"b\n\006Person\022+\n\010position\030\001 \001(\013"
  "2\031.PhysicsTelemetry.Vector4\022+\n\010velocity\030"
  "\002 \001(\0132\031.PhysicsTelemetry.Vector4B\037\252\002\034Phy"
  "sics.Telemetry.Serialisedb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_particle_2eproto_deps[1] = {
  &::descriptor_table_base_5ftypes_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_particle_2eproto_sccs[1] = {
...
void Person::InitAsDefaultInstance() {
  ::PhysicsTelemetry::_Person_default_instance_._instance.get_mutable()->position_ = const_cast< ::PhysicsTelemetry::Vector4*>(
      ::PhysicsTelemetry::Vector4::internal_default_instance());
  ::PhysicsTelemetry::_Person_default_instance_._instance.get_mutable()->velocity_ = const_cast< ::PhysicsTelemetry::Vector4*>(
      ::PhysicsTelemetry::Vector4::internal_default_instance());
}
class Person::_Internal {
 public:
  static const ::PhysicsTelemetry::Vector4& position(const Person* msg);
  static const ::PhysicsTelemetry::Vector4& velocity(const Person* msg);
};

const ::PhysicsTelemetry::Vector4&
Person::_Internal::position(const Person* msg) {
  return *msg->position_;
}
const ::PhysicsTelemetry::Vector4&
Person::_Internal::velocity(const Person* msg) {
...
Person::Person(const Person& from)
  ...
  // @@protoc_insertion_point(copy_constructor:PhysicsTelemetry.Person)
}

void Person::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_particle_2eproto.base);
...
void Person::Clear() {
// @@protoc_insertion_point(message_clear_start:PhysicsTelemetry.Person)
...
::PROTOBUF_NAMESPACE_ID::uint8* Person::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:PhysicsTelemetry.Person)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(message_byte_size_start:PhysicsTelemetry.Person)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:PhysicsTelemetry.Person)
  GOOGLE_DCHECK_NE(&from, this);
  const Person* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Person>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:PhysicsTelemetry.Person)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:PhysicsTelemetry.Person)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:PhysicsTelemetry.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:PhysicsTelemetry.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
